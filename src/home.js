...
function Home() {
  return (
    <nav class="full">
      ...
      <div class="info">
        The primary purpose of this organization is tosfacilitate the research,
        design, and development of space systems and related technology. These
        goals shall be achieved through creative and collaborative research
        methods while maintaining an encouraging and stimulating environment
      ...
      <div class="info">
        ...
        to get some signup information.
      </div>
      <div>
        <Footer />
      </div>
